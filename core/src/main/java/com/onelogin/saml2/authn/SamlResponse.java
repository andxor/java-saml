...
public class SamlResponse {
     ...
     * @param samlResponse A string containting the base64 encoded response from the IdP
     ...
     * @throws XPathExpressionException
     * @throws ValidationError          if multiple Response issuers were found
     ...
     * @throws XPathExpressionException
     * @throws ValidationError          if no Assertion Issuer could be found, or if multiple Assertion
     *                                  issuers were found
    ...
    public String getAssertionIssuer() throws XPathExpressionException, ValidationError {
        ...
        if (assertionIssuer.getLength() == 1) {
            ...
            throw new ValidationError("Issuer of the Assertion not found", ValidationError.ISSUER_NOT_FOUND_IN_ASSERTION);
        }
    }
     ...
     * @throws XPathExpressionException
     * @throws ValidationError          if multiple Response Issuers or multiple Assertion Issuers were
     ...
     *
     * @param validationException the validation exception to set
     */
     ...
     * @throws ValidationError if the found IssueInstant attribute is not in the expected
